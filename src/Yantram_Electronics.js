...
const Team6 = () => {
  ...
  const fetchData = () => {
    axios.get('https://ctop.iiit.ac.in/api/nodes/get-node/SC03-0032-0007/latest')
      .then(response => {
  ...
  useEffect(() => {
    fetchData();
    const intervalId = setInterval(fetchData, 3000); // Refresh data every 10 seconds
  ...
  return (
    <div>
      <h1 className="eco">Yantram Electronics</h1>
